...
<html lang="es">
    <head>
        ...
        <title>Página de Registro Alumnos</title>
    ...
    <div class="container-fluid">
            <?php  
                ...
                $existeEmail = "SELECT * FROM alumnos WHERE Nom_Usu = '$_POST[Usuario]'";
                ...
                if($count == 1){
                    ...
                    echo "<div class= 'alert alert-warning mt-4' role='alert'>
                            ...
                            <p><a href='../CuentaA.html'>Por favor, vuelva a la página de CrearCuenta.</a></p>
                        </div>
                    ";
                }else{
                    ...
                    $query = "INSERT INTO alumnos (Nombre, Apellido1, Apellido2,Email, Nom_Usu, Contraseña) VALUES ('$nombre', '$apellido1', '$apellido2', '$email','$usuario','$contrasena')";

...
<body>
    ...
    <?php
            ...
            $select = "SELECT Id_Asignatura, Fecha_Hora, Año_Academico FROM retrasos WHERE Id_Alumno = '$id'";
            ...
            if ($rows === 0) {
                echo '<p class="text-center display-4"> No tienes ningun retraso o no te da clase ningun profesor
                </p>';
            } else {
